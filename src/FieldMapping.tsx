...
export function FieldMapping({ collection, dataSource, initialSlugFieldId, accessToken }: FieldMappingProps) {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await syncCollection(collection, dataSource, fieldsToSync, selectedSlugField, accessToken)
