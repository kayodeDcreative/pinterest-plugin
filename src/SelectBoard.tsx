...
export function SelectBoard({ accessToken, onSelectDataSource }: SelectBoardProps) {
        ...
        <main className="framer-hide-scrollbar setup">
            <div className="intro">
                ...
                <div className="content">
                    <h2>Pinterest</h2>
                    <p>Enter your board ID to sync your pins.</p>
                </div>
            </div>
            ...
            <div className="form">
                ...
                <button onClick={handleConnect} disabled={isLoading || !boardId}>
